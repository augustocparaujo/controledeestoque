                        ...
                        <div class="body">
                            <div class="table-responsive" style="font-size:12px !important">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>';
                                    $sql = $conpdo->prepare("SELECT * FROM estoque WHERE localidade='CD-Uberlandia'");
                                    $sql->execute();
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <select type="text" class="form-control" name="almoxarifado" placeholder="Almoxarifado" required>
                            <option value="">selecione</option>
                            <option value="Sala de estoque">Sala de estoque</option>
                            <option value="Armário">Armário</option>	
                            <option value="Sala de TI">Sala de TI</option>
